            ...
            <div className="rounded-2xl bg-[#0e1017]/80 backdrop-blur-xl border border-white/10 p-5 space-y-4 shadow-lg">
              ...
              <div className="pt-2">
                <button
                  type="button"
                  onClick={onGenerateMore}
                  className="w-full btn-helium py-3 px-4 rounded-xl font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 shadow-lg cursor-pointer"
                >
                  <PlusCircle className="w-4 h-4 text-black" />
